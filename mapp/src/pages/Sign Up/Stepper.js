        ...
        return (
            <div key={index}
                ...
                <div className="relative flex flex-col ps-8 items-center text-teal-600">
                    ...
                    <div
                        className={`absolute top-0 text-center mt-16 w-32 text-xs font-medium uppercase ${step.higlighted ? "text-gray-900" : "text-gray-400"}`}>
                        {/* Display Description */}
                        {step.description}
                    </div>
                </div>
                <div
                    className={`flex-auto border-t-2 transitionn duration-500 ease-in-out ${step.completed ? "border-gray-900" : "border-gray-300"} `}>
                    {/* Display Line*/}
                </div>
            </div>
        );
